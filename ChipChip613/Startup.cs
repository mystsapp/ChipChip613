...
namespace ChipChip613
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ChiChip613DbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"))/*.EnableSensitiveDataLogging()*/);
